...
Boundaries between “editorial” and “scientific/numerical” reproducibilities are not always clear and may be blurred or moving. For example, some contributions which computational workloads completely fits the CI rendering process and provides also near-perfect reproducibility of their materials, if approved, achieve both reproducibilities in a single step. But other contributions, for example involving simulations, large amount of datas or complex deep-learning models may require a more “hands-on” reproducibility process. One of the perspectives of Computo is to broaden the automated reproducibility scope to include more and more “scientific” reproducibility, and, ultimately, to provide authors a full array of computational ressources to allow them to include their own scientific/numerical reproducibility developing process in the editorial one.