...
- [*Computo* Template for R users](https://github.com/computorg/template-computo-R)^[`Quarto` R-based notebooks are similar to Rmarkdown notebooks and `Quarto` natively understand Rmarkdown notebook.]
